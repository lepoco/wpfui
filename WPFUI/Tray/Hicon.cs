...
internal static class Hicon
{
    ...
    public static IntPtr FromApp()
    {
        ...
        {
#if DEBUG
            System.Diagnostics.Debug.WriteLine($"ERROR | Unable to get application hIcon - {e}", "WPFUI.Hicon");
            throw;
#endif
        }
    ...
    public static IntPtr FromSource(ImageSource source)
    {
        ...
        {
#if DEBUG
            System.Diagnostics.Debug.WriteLine($"ERROR | Unable to allocate hIcon, Decoder source is empty", "WPFUI.Hicon");
#endif
        ...
        {
#if DEBUG
            System.Diagnostics.Debug.WriteLine($"ERROR | Unable to allocate hIcon, allocation failed.", "WPFUI.Hicon");
#endif
