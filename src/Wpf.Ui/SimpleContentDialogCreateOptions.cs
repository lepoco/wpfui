...
public class SimpleContentDialogCreateOptions
{
    ...
    /// disabled while the dialog is displayed.
    /// </summary>
    /// <remarks>
    /// Disabling sibling elements helps enhance dialog security.
    /// See <see cref="ContentDialog.DisableSiblings"/> for more information.
    /// </remarks>
    public bool DisableSiblings { get; set; }
}
