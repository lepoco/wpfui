...
public struct HsvColor
{
    ...
    public HsvColor() : this(0, 0, 0, 255) { }

    public HsvColor(double hue, double saturation, double value) : this(hue, saturation, value, 255) { }

    public HsvColor(double hue, double saturation, double value, byte alpha)
    {
        Hue = hue;
    ...
    public Color ToColor()
    {
        ...
        if (chroma == 0)
        {
            return Color.FromArgb(alpha, (byte)(min * 255), (byte)(min * 255), (byte)(min * 255));
        }
        ...
        switch (sextant)
        {
            case 0:
                red = max;
                green = min + chroma * intermediateColorPercentage;
                blue = min;
                break;
            case 1:
                red = min + chroma * (1 - intermediateColorPercentage);
                green = max;
                blue = min;
                break;
            case 2:
                red = min;
                green = max;
                blue = min + chroma * intermediateColorPercentage;
                break;
            case 3:
                red = min;
                green = min + chroma * (1 - intermediateColorPercentage);
                blue = max;
                break;
            case 4:
                red = min + chroma * intermediateColorPercentage;
                green = min;
                blue = max;
                break;
            case 5:
                red = max;
                green = min;
                blue = min + chroma * (1 - intermediateColorPercentage);
                break;
        }

        return Color.FromArgb(alpha, (byte)(red * 255), (byte)(green * 255), (byte)(blue * 255));
    }
