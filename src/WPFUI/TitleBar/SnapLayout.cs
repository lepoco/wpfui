...
internal sealed class SnapLayout : IThemeControl
{
    ...
    /// </summary>
    private SnapLayout(Window window, WPFUI.Controls.Button maximizeButton, WPFUI.Controls.Button restoreButton)
    {
        if (window == null)
            return;
    ...
    public static SnapLayout Register(Window window, WPFUI.Controls.Button maximizeButton, WPFUI.Controls.Button restoreButton)
    {
