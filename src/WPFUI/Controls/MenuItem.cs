...
/// <summary>
/// Extended <see cref="System.Windows.Controls.MenuItem"/> with <see cref="WPFUI.Common.SymbolRegular"/> properties.
/// </summary>
public class MenuItem : System.Windows.Controls.MenuItem
{
    ...
    public static readonly DependencyProperty SymbolIconProperty = DependencyProperty.Register(nameof(SymbolIcon),
        typeof(Common.SymbolRegular), typeof(WPFUI.Controls.MenuItem),
    ...
    public static readonly DependencyProperty SymbolIconFilledProperty = DependencyProperty.Register(
        ...
        typeof(bool), typeof(WPFUI.Controls.MenuItem), new PropertyMetadata(false));
    ...
    //    typeof(Brush), typeof(WPFUI.Controls.MenuItem), new FrameworkPropertyMetadata(
    ...
    ///// <summary>
    ///// Foreground of the <see cref="WPFUI.Common.SymbolRegular"/>.
    ///// </summary>
    //[Bindable(true), Category("Appearance")]
