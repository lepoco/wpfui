...
public partial class MonacoWindowViewModel : ObservableObject
{
    ...
    public void SetWebView(WebView2 webView)
    {
        ...
        webView.Source =
            new Uri(System.IO.Path.Combine(System.AppDomain.CurrentDomain.BaseDirectory, @"Assets\Monaco\index.html"));
